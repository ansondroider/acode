...
public abstract class Part {
    ...
    protected void sendStart(OutputStream out) throws IOException {
        //ALog.d("enter sendStart(OutputStream out)");
    ...
    protected void sendDispositionHeader(OutputStream out) throws IOException {
        //ALog.d("enter sendDispositionHeader(OutputStream out)");
     ...
     */
     protected void sendContentTypeHeader(OutputStream out) throws IOException {
        //ALog.d("enter sendContentTypeHeader(OutputStream out)");
     ...
     */
     protected void sendTransferEncodingHeader(OutputStream out) throws IOException {
        //ALog.d("enter sendTransferEncodingHeader(OutputStream out)");
    ...
    protected void sendEndOfHeader(OutputStream out) throws IOException {
        //ALog.d("enter sendEndOfHeader(OutputStream out)");
        out.write(CRLF_BYTES);
        out.write(CRLF_BYTES);
    }
    ...
    protected void sendEnd(OutputStream out) throws IOException {
        //ALog.d("enter sendEnd(OutputStream out)");
        out.write(CRLF_BYTES);
    }
    ...
    public void send(OutputStream out) throws IOException {
        //ALog.d("enter send(OutputStream out)");
        sendStart(out);
