...
public class HolographicOutlineHelper {
     ...
     */
    public static Bitmap createGlowingOutline(Bitmap bm, int outlineColor, int glowColor) {
        final int padding = INSTANCE.mMaxOuterBlurRadius;
        final Bitmap b = Bitmap.createBitmap(
                bm.getWidth() + padding, bm.getHeight() + padding, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(b);
        canvas.drawBitmap(bm, 0, 0, null);
        canvas.setBitmap(b);
        INSTANCE.applyExtraThickExpensiveOutlineWithBlur(b, canvas, glowColor, outlineColor);
